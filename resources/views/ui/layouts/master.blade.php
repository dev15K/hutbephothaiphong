...
<head>
    ...
    <link rel='prefetch' href='{{ asset('ui/vendor/flatsome/assets/js/chunk.countupafc7.js') }}'/>
    <link rel='prefetch' href='{{ asset('ui/vendor/flatsome/assets/js/chunk.sticky-sidebarafc7.js') }}'/>
    <link rel='prefetch' href='{{ asset('ui/vendor/flatsome/assets/js/chunk.tooltipsafc7.js') }}'/>
    <link rel='prefetch' href='{{ asset('ui/vendor/flatsome/assets/js/chunk.vendors-popupsafc7.js') }}'/>
    <link rel='prefetch' href='{{ asset('ui/vendor/flatsome/assets/js/chunk.vendors-sliderafc7.js') }}'/>
    <link rel="alternate" type="application/rss+xml"
          title="Dòng thông tin CÔNG TY MÔI TRƯỜNG ĐÔ THỊ HẢI PHÒNG Hotline: 0355 662 658 &raquo;"
          href="{{ route('home') }}"/>
    <script type="text/javascript">
        ...
        window._wpemojiSettings = {
            ...
            "svgExt": ".svg",
            "source": {"concatemoji": "https:\/\/vesinhmoitruongso1.com\/wp-includes\/js\/wp-emoji-release.min.js?ver=6.5.4"}
        };
    ...
    <link rel='stylesheet' id='flatsome-main-css'
          href='{{ asset('ui/vendor/flatsome/assets/css/flatsomeafc7.css') }}' type='text/css' media='all'/>
    ...
    <div class="ring-wrap" style="bottom: 0% !important;">
        ...
        <div class="mess-ring" style="display: none !important;">
            ...
            <div class="mess-ring-img-circle">
                <a href="#" target="_blank" class="pps-btn-img">
                    <img src="{{ asset('ui/img/mess.png') }}" alt="" width="50"/>
                </a>
            </div>
        </div>
        <!--  End Mess	 -->
        ...
        <div class="zalo-ring" style="display: none !important;">
            ...
            <div class="zalo-ring-img-circle">
                <a href="https://zalo.me/0355662658" target="_blank" class="pps-btn-img">
                    <img src="{{ asset('ui/img/zalo-img.png') }}" alt="" width="50"/>
                </a>
            </div>
        </div>
        <!--  End Zalo	 -->
        ...
        <div class="hotline-phone-ring" style="display: block !important;">
            ...
            <div class="hotline-phone-ring-img-circle">
                <a href="tel:0355662658" class="pps-btn-img">
                    <img src="{{ asset('ui/img/phone.png') }}" alt="" width="50"
                         style="transform: initial"/>
                </a>
            </div>
        </div>
        <div class="hotline-bar" style="display: block;">
            <a href="tel:0355662658">
                <span class="text-hotline">0355662658</span>
            </a>
        </div>
        <!--  End hotline   -->
    </div>
    ...
    <script>(function (w, d, s, l, i) {
            ...
            j.async = true;
            j.src =
                'https://www.googletagmanager.com/gtm.js?id=GTM-XXXXXXX' + dl;
    ...
    <style id="custom-css" type="text/css">:root {
        ...
        .header-bg-color {
            background-color: rgba(6, 159, 170, 0.9)
        }
...
<body
    class="home page-template page-template-page-blank page-template-page-blank-php page page-id-9 lightbox nav-dropdown-has-arrow nav-dropdown-has-shadow nav-dropdown-has-border">
...
<div id="main-menu" class="mobile-sidebar no-scrollbar mfp-hide">
    ...
    <div class="sidebar-menu no-scrollbar ">
        ...
        <ul class="nav nav-sidebar nav-vertical nav-uppercase" data-tab="1">
            ...
            <li class="menu-item menu-item-type-post_type menu-item-object-post menu-item-74">
                <a href="#">Chính sách cam kết</a>
            </li>
            <li class="menu-item menu-item-type-post_type menu-item-object-post menu-item-103">
                <a href="#">Liên hệ</a>
            </li>
        </ul>
